...
#items: monster
#stuff: loot
#starting conditions: dark, monster alive
...
#Commands specific to this room
    ...
    while ($monster eq "alive"){
        print "Something stirs in the darkness...\n";
    ...
    if ($command eq "items"){
        print "The room contains a big scary monster (unless you killed it)\n";
        print "It has two doors leading out\n";
        command();
    }
